		...
		{/* navbar */}
			...
			<main className="sm:p-8 px-4 py-8 w-full bg-[#f9fafe] min-h-[calc(100vh-73px)]">
				<Routes key={location.pathname} location={location}>
					...
					<Route path="/signin" element={<React.Suspense fallback= {<PageLoadingScreen/>} > <LazySignIn/> </React.Suspense>} />
					<Route path="/signup" element={<React.Suspense fallback= {<PageLoadingScreen/>} > <LazySignUp/> </React.Suspense>} />
