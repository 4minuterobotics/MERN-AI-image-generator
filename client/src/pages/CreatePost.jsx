	...
	const generateImage = async () => {
		if (form.prompt) {
			...
			try {
				...
				// https://image-generator-backend-c9nm.onrender.com/api/v1/dalle for remote backend
	...
	const handleSubmit = async (e) => {
		...
		if (form.prompt && form.photo) {
			...
			try {
				...
				// https://image-generator-backend-c9nm.onrender.com/api/v1/post for remote backend
